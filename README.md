...
- **21 processors** detecting **39 anti-patterns** across DI, code quality, templates, performance, and architecture
...
- [Available Processors](docs/processors.md) - All 21 processors (39 rules)
